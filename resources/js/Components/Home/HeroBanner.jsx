...
export default function HeroBanner() {
    return (
        <div>
            <Parallax 
                blur={{min: -10, max: 10}} 
                bgImage={'/storage/img/illustrations/herobanner.jpg'} 
                bgImageAlt={'Bannière'} 
                strength={-150} 
            ...
            >
                <div className="max-w-7xl md:mx-auto md:py-36 py-2 md:my-auto mx-2">
                    <div className="flex flex-col md:flex-row gap-4 my-auto">
                        <div className="w-full h-full md:w-1/3 p-4 my-2 md:my-0 bg-gray-800 rounded-xl shadow-lg bg-opacity-80">
