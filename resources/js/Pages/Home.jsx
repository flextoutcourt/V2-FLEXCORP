                ...
                >
                    <main data-scroll-container ref={containerRef}>
                        ...
                        <div className="w-full mt-4 text-white">
                            <div className="py-4 sticky top-16 bg-gray-900 z-20">
                                <h3 className="text-2xl">{t("home.chooseMe")}</h3>
                                <p>{t("home.goodKnowledge")}</p>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4" id="scroll-direction">
                                <section data-scroll data-scroll-section id="direction" data-scroll-sticky data-scroll-target="#scroll-direction" >
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 z-10 -translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="-2" data-scroll-target="#direction">
                                    ...
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 z-10 -translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="-4" data-scroll-target="#direction">
                                        <div className="flex align-middle justify-start my-2 px-3">
                                    ...
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 z-10 -translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="-6" data-scroll-target="#direction">
                            ...
                            <div className="md:my-12 md:h-1" ></div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4" id="l-direction">
                                <div className="hidden md:block">
                                    <img src="/storage/img/illustrations/design.svg" alt="Design" className="my-auto w-full" style={{maxHeight: 450}} />
                                </div>
                                <section data-scroll data-scroll-section id="direction-b" data-scroll-sticky data-scroll-target="#l-direction" >
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="2" data-scroll-target="#direction-b">
                                        <div className="flex align-middle justify-start my-2 px-3">
                                            <img src="/storage/img/bootstrap.svg" className="max-h-8" alt="Bootstrap" />
                                    ...
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="4" data-scroll-target="#direction-b">
                                        <div className="flex align-middle justify-start my-2 px-3">
                                            <img src="/storage/img/tailwindcss.svg" className="max-h-8" alt="TailwindCss" />
                        ...
                        <div className="w-full mt-4 text-white">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <section data-scroll data-scroll-section id="direction-l" data-scroll-sticky data-scroll-target="#scroll-direction" >
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 -translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="-2" data-scroll-target="#direction-l">
                                        <div className="flex align-middle justify-start my-2 px-3">
                                    ...
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 -translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="-4" data-scroll-target="#direction-l">
                                        <div className="flex align-middle justify-start my-2 px-3">
                                    ...
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 -translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="-6" data-scroll-target="#direction-l">
                                        <div className="flex align-middle justify-between my-2 px-3">
                            ...
                            <div className="md:my-12 md:h-1" ></div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4" id="p-direction">
                                <div className="h-full hidden md:block">
                                    <img src="/storage/img/illustrations/progress.svg" alt="progress" className="w-full my-auto" style={{maxHeight: 450}} />
                                </div>
                                <section data-scroll data-scroll-section id="direction-p" data-scroll-sticky data-scroll-target="#p-direction" >
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="2" data-scroll-target="#direction-p">
                                        <div className="flex align-middle justify-start my-2 px-3">
                                    ...
                                    <div className="mt-4 bg-gray-800 shadow-lg rounded-md p-4 translate-x-full" data-scroll-direction="horizontal" data-scroll data-scroll-speed="4" data-scroll-target="#direction-p">
                                        <div className="flex align-middle justify-start my-2 px-3">
